...
!function () {
    ...
    var e = window.document, o = e.location, t = window.Math, r = window.HTMLElement, a = window.XMLHttpRequest,
        n = "github-button", i = "https://buttons.github.io/buttons.html", l = "github.com",
        c = a && "prototype" in a && "withCredentials" in a.prototype,
        d = c && r && "attachShadow" in r.prototype && !("prototype" in r.prototype.attachShadow), s = function (e, o) {
            ...
            var i = "large" === b(o["data-size"]), c = r("a", {
                    className: "btn",
                    href: o.href,
                    rel: "noopener",
                    target: "_blank",
            ...
            if (((s === l || s === "gist." + l) && "archive" === f[3] || s === l && "releases" === f[3] && ("download" === f[4] || "latest" === f[4] && "download" === f[5]) || s === "codeload." + l) && (c.target = "_top"), "true" === b(o["data-show-count"]) && s === l && "marketplace" !== f[1] && "sponsors" !== f[1] && "orgs" !== f[1] && "users" !== f[1] && "-" !== f[1]) {
                var h, v;
                if (!f[2] && f[1]) v = "followers", h = "?tab=followers"; else if (!f[3] && f[2]) v = "stargazers_count", h = "/stargazers"; else if (f[4] || "subscription" !== f[3]) if (f[4] || "fork" !== f[3]) {
                    if ("issues" !== f[3]) return void t(d);
                    v = "open_issues_count", h = "/issues"
                } else v = "forks_count", h = "/network/members"; else v = "subscribers_count", h = "/watchers";
